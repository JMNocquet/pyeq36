...
#        print('-------------------------------------------------------------------------')  
        ...
        for k in lk:
            ...
            Atmp, Btmp, Ctmp, ATPB_Ctmp = pyeq.lib.forward_model.C_B_at_k_build4( k, model.nstep, model.np_gps_site , model.np_obs_date_s, model.np_model_date_s, model_time_step, GAMMA_MATRIX, G_PER_SITE, dk, sdk)

def print_stats( model ):
    ...
    T_MOD , np_names_t_obs, np_obs_date_s = pyeq.lib.obs_tensor.sgts2obs_tensor.sgts2tensor( model.Mgts )
    T_RES , np_names_t_obs, np_obs_date_s = pyeq.lib.obs_tensor.sgts2obs_tensor.sgts2tensor( model.Rgts )
    ...
    # bias (keep the component separeted)
